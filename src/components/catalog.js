...
import "./catalogAssets/catalog.css";

function GalleryItem(props) {
    return (
        <div className={props.parentClass + "__item"}>
            <div className={props.parentClass + "__img-b"}>
                ...
                <img
                    src={props.img}
                    alt="catalog_item"
                    className={props.parentClass + "__img"}
                />
                {props.sale && (
                    <svg
            ...
            {props.sale && (
                <div className="catalog__price">
                    ...
                    <span> / </span>
                    <span className="catalog__price--new">
                        {props.salePrice}
                    </span>
                </div>
            )}
...
function MainPage(props) {
    ...
    return (
        <div className="catalog-wrapper">
            <div className="catalog-main">{gallery}</div>
            <CatalogButton />
        </div>
    );
}
function All() {
    ...
    return (
        <div className="catalog-wrapper">
            <div className="catalog-all">{gallery}</div>
            <CatalogButton />
        </div>
    );
}
...
export default function Catalog(props) {
    if (props.type === "main") return <MainPage />;
    if (props.type === "all") return <All />;
    if (props.type === "shirts") return <Shirts />;
    if (props.type === "dress") return <Dress />;
}
let catalogBase = [
    {
        text: "Сукня замшева вишнева",
        img: "/items/dress_cherry.jpg",
        price: "550₴",
        sale: false,
        new: true,
        id: 1,
    ...
    {
        text: "Сукня замшева темно-зелена",
        img: "/items/dress_dark-green.jpg",
        price: "550₴",
        sale: false,
        new: false,
        id: 3,
    ...
    {
        text: "Сорочка блакитна",
        img: "/items/shirt_blue.jpg",
        price: "550₴",
        sale: false,
        new: false,
        id: 4,
    ...
    {
        text: "Сорочка молочна",
        img: "/items/shirt_milk.jpg",
        price: "550₴",
        sale: true,
        salePrice: "333₴",
        new: false,
    ...
    {
        text: "Піджак в шотланську клітинку Khaby",
        img: "/items/jacket_khaby.jpg",
        price: "550₴",
        sale: false,
        new: false,
        id: 7,
